...
def calc_build_possibilities(bp, resources, robots, max_cost):
    ...
    if cst[ORE][ORE] <= resources[ORE]: # and robots[ORE] < max_cost[ORE]:
        possibles.append(ORE)

    #if not possibles: # or (possibles[0] != OBSIDIAN and len(possibles) == 1):
...
# print(calc_blueprint_quality(blueprints[8]))
