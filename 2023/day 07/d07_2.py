...
def kind_val(cards):
    ...
    if distinct_cards == 1 or (distinct_cards == 2 and js):
        ...
        return THREE_OF_A_KIND if js else ONE_PAIR
    return ONE_PAIR if js else HIGH_CARD
